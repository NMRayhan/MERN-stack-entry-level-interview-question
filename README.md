...
**Ans: Controlled component:** Form data are handled by a React component. A Controlled Component is one that takes its current value through props and notifies changes through callbacks like onChange. A parent component "controls" it by handling the callback and managing its own state and passing the new values as props to the controlled component. You could also call this a "dumb component".
...
### 131. React Life cycle component
...
<img src="https://github.com/mrhm-dev/full-stack-army/blob/master/class-overview/Lecture-01/Waterfall_model.png?raw=true" alt="Waterfall model"/>
