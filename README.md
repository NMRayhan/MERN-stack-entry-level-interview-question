...
HTML4
HTML5
Html 4 is not a mobile friendly
Html5 is mobile friendly
Html4 is older version of html
Html5 is modern version of html
It is not supported any audio or video without flash player
It is supported to audio and video using audio and video tag and it’s control
Document declaration is to complicated and log statement
Document declaration is vary easy and to short
It’s not possible to drag and drop
It’s possible to use drag and drop
User Geolocation access not possible this version
Easy to access user Geolocation
Not allow to run javascript in browser
Allow to run javascript in browser
...
Ans: Purpose of Article, div, section, nav, aside:-
...
or Differences between Class selector from ID selector?
...
21. What is a CSS Preprocessor? What are some benefits of Sass?
...
22. What is a Pseudo element? Give an example of pseudo element
...
or What are some CSS Measuring units? Which one will you use?
...
25. Difference between transition and transform?
...
26. How will you horizontally and vertically center a div inside a div?
...
28. What is the universal selector in CSS?
...
30. How does JavaScript code is executed in Browser?
...
31. What are the differences between “==” and “===” ?
...
33. When will you return something from a function? 
Ans: when we need to calculate or finish any task while waiting for another task or calculation depends on previous function return result this time need to return from a function.
...
34. Tell me about bind, call and apply?
...
35. What is a Closure in JavaScript? How does it work?
...
36. What does the “this” keyword indicate in JavaScript?
...
37. What is Event bubbling in js? 
...
39. What is a recursive function function
...
40. Difference between undefined and null
...
43. Is JavaScript a static type or a dynamic type?
...
44. What is the output of 10+20+"30" in JavaScript?
...
45. Are Java and JavaScript the same?
...
46. How to handle exceptions in JavaScript?
...
49. Why will you use default parameters?
Ans: 
Use default parameter, when we declare a function with parameter but accidentally when call this function we don’t provide any argument this time function will show error, and this error handle solution is default parameter if we use any default parameter with value and function call without any argument it’s working.

50. How does the Spread operator work?
Ans: 
Javascript Spread Operator is if we need to copy all the element of Array or key value pair of object we use Spread Operator, in javascript Spread operator is work by (...)three dot of and then previous Object or Array and copied to newOne with previous Value.
...
53. Explain Call by value vs call by reference?
...
Ans: Javascript scope is accessibility of variables to javascript. Block scope is a variable to inner the function using let or var keyword, Global scope are those variables to declare to outside of Block.

Or Block scope and global scope, Lexical scope এর পার্থক্য
...
56. What is API? Difference between Get vs post?
...
57. Difference between local storage and Session storage?
...
58. What are cookies? And why will you use it?
...
60. Difference between Array vs LinkedList?
...
61. How will you debug a JavaScript application?
...
62. What is Higher order function?
...
63. What is the main pillar of OOP?
Ans: 
...
64. What is reactjs? Tell us about advantages and disadvantages of using react js?
Ans: 
ReactJS is a Modern Javascript Library. It's a more efficient, declarative reusable component library for creating single page applications.
...
Disadvantage: 
ReactJS uses JSX. It's a syntax extension that allows HTML with JavaScript mixed together.ReactJS Covers only the UI Layers of the app and nothing else and also poor documentation.

65. Why will you select ReactJS?

Or there are so many different javascript frameworks. Why will you use ReactJS for your application
Ans: 
One of the main benefits of using React js is the Reusable Component. Its saves time for developers and they don’t have to code rewrite of the same features.
...
66. What is Virtual dom? What are the differences between virtual and real dom?
...
67. Differences between props and state?
...
68. What is the purpose of useState? When and why will you use it?
...
69. What is a context API? How does it work?
...
70. Difference between useEffect and useState?
...
71. What is JSX? How does it work
...
72. Tell us about React Component lifecycle.
...
73. What is the purpose of a custom hook? How will you create a custom hook? Give us an example.
...
export default Home;
74. How would you optimise a react js application
...
75. How will you send data from a Child Component to the parent component?
...
76. What is the best way to send 4 or more props to a child component?
...
77. What is Redux and and what is the purpose of Redux?
...
78. What is React native? What do you know about React Native?
...
79. What are Higher order components? Give us an example.
...
80. Is there any reason to return something from a UseEffect hook?
...
81. How will you optimise a react application?
Ans: Some step taking can optimise a react application, describe hrer:
use Stateless Components and React.PureComponent.
Multiple Chunk Files.
Dependency optimization.
...
82. What are the different ways to manage state in a React Application?
...
83. Why do we inject dependency inside a UseEfect hook?
...
84.  How will you prevent re-render in react applications?
Ans: React.memo() to prevent re-rendering on React function components.

85. Tell me some disadvantages of Reactjs
...
86. Does React perform one-way data binding or two way data binding?
...
89. Nodejs single threaded or multi threaded
Ans: Nodejs is single threaded

90. NodeJs ব্লকিং না নন-ব্লকিং কাজ করে
...
92. What is the purpose of a database?
...
93. sql vs nosql মধ্যে পার্থক্য কি? কোনটা বেশি ব্যবহার হয়
...
94. রিয়েক্ট এর সাথ node, Mongodb কেন ইউস করা হয়ছে MySql কেন নয়?
...
95. Database design, database schema design বলতে কি বুজো?
...
96. সার্ভার সাইট ক্রাস করলে কি করবেন?
...
99. Get vs post?
Ans: Get vs Post
The GET method has a limited amount of data sent but the POST method is not limited in sending data.
GET method data sending with header but POST data is sent in body.
GET request is not secured because data is exposed in the URL bar but Post request is secured because data is not exposed in URL bar.
GET request can be bookmarked but POST request cannot be bookmarked.

100. PUT and Patch এর মধ্যে পার্থক্য কি?
